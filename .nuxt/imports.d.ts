...
export { useWatermark } from '../app/composables/useWatermark';
export { loadImage, drawTextWatermark, applyWatermarks, exportImage, downloadImage, handleClipboardPaste } from '../app/utils/imageProcessor';

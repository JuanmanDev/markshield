      ...
      import { customSafelistExtractor, generateSafelist } from "C:/code/watermark/node_modules/@nuxt/ui/dist/runtime/utils/colors";
      ...
      export default {
        ...
        content: {
          files: [
            "C:/code/watermark/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "C:/code/watermark/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
